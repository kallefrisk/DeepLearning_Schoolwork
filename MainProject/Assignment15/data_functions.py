...
def load_folder_with_split(
    ...
    Args:
        ...
        target_path: The path of the target data file, None for target in same file
        ...
        target_column: the target column in the same file if in same file
    ...
    elif target_path is None and target_column is None:
        raise Exception("target_column cannot be None if target in same file")
    ...
    for file in os.listdir(folder_path):
        ...
        if target_path is not None and file_name not in files:
            pass
        else:
